...
export interface DbSenderIdentity { id:string;workspaceId:string;domainId:string;fromName:string;fromEmail:string;replyTo:string;purpose:"marketing"|"transactional";status:string; }
...
export interface Phase1Repository {
  ...
  updateDomainSendingPurpose(workspaceId:string,domainId:string,purpose:"marketing"|"transactional"):Promise<DbSenderDomain>;
  ...
  createSenderIdentity(input:{workspaceId:string;domainId:string;fromName:string;fromEmail:string;replyTo:string;purpose:"marketing"|"transactional"}):Promise<DbSenderIdentity>;
