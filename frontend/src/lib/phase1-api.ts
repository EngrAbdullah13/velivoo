...
const friendlyErrors:Record<string,string>={
  ...
  DOMAIN_REMOVAL_CONFIRMATION_REQUIRED:'Type the exact domain name in the confirmation box, then click Remove domain again.',
  EMAIL_IDENTITY_DELETE_FAILED:'Velivoo removed this domain from your workspace, but AWS SES cleanup could not finish. The domain should now be gone here; if it still appears, click Remove domain again.',
  DOMAIN_HAS_ACTIVE_SENDS:'Wait until active sends finish, then try removing the domain again.',
